...
MAP_PROMPT = (
    ...
    "- If there are more facts than fit, keep the rare ones first: an event that\n"
    "  appears only once outranks repeated traffic.\n"
...
FINAL_PROMPT = (
    ...
    "- Keep every event that appears only once in the text; never drop a rare event\n"
    "  to save space.\n"
