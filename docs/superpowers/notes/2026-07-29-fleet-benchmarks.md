...
- 507fbaf fixwave: draft replaced (exit 0, valid format, but typed "feat(README.md):" — wrong type, scoped to a filename, and named only the README sentence, omitting the actual code fix and the other four doc files it touched)
